...
export const defaultStandards: StandardDocument[] = [
  normalizeStandardDocument({
    ...
    sourceType: "seed",
    provider: "다음한걸음",
    sourceName: "NCIC 국가교육과정정보센터 metadata + demo lesson scenario",
    sourceUrl: "https://ncic.re.kr/",
    license: "데모 seed. 공식 원문 corpus가 아니며, NCIC 저작권 정책 확인 필요.",
  ...
  normalizeStandardDocument({
    ...
    sourceType: "seed",
    provider: "다음한걸음",
    sourceName: "다음한걸음 데모 내장 기준",
    license: "데모 seed. 공식 원문 corpus 아님.",
    collectedAt: "2026-05-29T00:00:00.000Z",
    schoolLevel: "초등학교",
    chunkType: "standard",
